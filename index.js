...
const SUB_PATH = process.env.SUB_PATH || '1038';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || 'edd22f51-530a-4fdd-a550-65817576dffb'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '1038zaiyp.4932135.xyz ';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMDY1NmY4MTRiMDJhZTRiMzcyYjlmOWE5YWE4YTBmYjMiLCJ0IjoiYTFjMGJjZTQtNGJmZC00ZGMzLWJhYWQtZTljZTk3MjI1ZjJhIiwicyI6Ill6QTJNR1V4WXpRdFpUQXdNQzAwTmpBekxUa3dZbVF0TldObU1HUmtZVEl5TTJVeiJ9
...
const NAME = process.env.NAME || '1038zaiyp';                        // 节点名称
